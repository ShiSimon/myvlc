...
public:
    ...
    void setupUi(QWidget *SPrefsInterface)
    {
        ...
        continueBox = new QCheckBox(groupBox_2);
        continueBox->setObjectName(QStringLiteral("continueBox"));

        gridLayout_5->addWidget(continueBox, 3, 0, 1, 4);
    ...
    void retranslateUi(QWidget *SPrefsInterface)
    {
        ...
        continueBox->setText(Q_("Continue playback?", 0));
