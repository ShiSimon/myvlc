...
public:
    ...
    void retranslateUi(QWidget *Profiles)
    {
        ...
        FLACMux->setText(Q_("FLAC", 0));
        MOVMux->setText(Q_("MP&4/MOV", 0));
        OggMux->setText(Q_("Ogg/Ogm", 0));
        MKVMux->setText(Q_("M&KV", 0));
        MJPEGMux->setText(Q_("M&JPEG", 0));
        PSMux->setText(Q_("MPEG-PS", 0));
        FLVMux->setText(Q_("F&LV", 0));
        ...
        vFrameLabel->setText(Q_("Fra&me Rate", 0));
        ...
        aSampleLabel->setText(Q_("Sa&mple Rate", 0));
