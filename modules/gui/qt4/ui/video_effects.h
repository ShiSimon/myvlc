...
public:
    ...
    void setupUi(QTabWidget *ExtVideoWidget)
    {
        ...
        puzzleBlackSlotCheck->setObjectName(QStringLiteral("puzzleBlackSlotCheck"));
        ...
        atmoEdgeweightningSlider->setObjectName(QStringLiteral("atmoEdgeweightningSlider"));
        ...
        atmoBrightnessSlider->setObjectName(QStringLiteral("atmoBrightnessSlider"));
        ...
        atmoFiltermodeCombo->setObjectName(QStringLiteral("atmoFiltermodeCombo"));
        ...
        atmoDarknesslimitSlider->setObjectName(QStringLiteral("atmoDarknesslimitSlider"));
        ...
        atmoShowdotsCheck->setObjectName(QStringLiteral("atmoShowdotsCheck"));
        ...
        atmoMeanlengthSlider->setObjectName(QStringLiteral("atmoMeanlengthSlider"));
        ...
        atmoMeanthresholdSlider->setObjectName(QStringLiteral("atmoMeanthresholdSlider"));
        ...
        atmoPercentnewSlider->setObjectName(QStringLiteral("atmoPercentnewSlider"));
