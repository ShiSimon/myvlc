...
public:
    ...
    void setupUi(QWidget *SPrefsAudio)
    {
        ...
        dolbyLabel->setObjectName(QStringLiteral("dolbyLabel"));
        ...
        headphoneEffect->setObjectName(QStringLiteral("headphoneEffect"));
        ...
        detectionDolby->setObjectName(QStringLiteral("detectionDolby"));
